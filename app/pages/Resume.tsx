...
const Resume = () => (
  <section className="resume-section p-6 bg-gray-100 flex justify-center items-center min-h-screen">
    ...
    <h2 className="summary-title text-2xl font-semibold mb-4 text-right">Summary</h2>
    <p className="summary-text text-lg text-right">
